...
enum EnumPostgresErrorCode {
   ...
   * [W] no_additional_dynamic_result_sets_returned
  */
   ...
   * [E] inappropriate_isolation_level_for_branch_transaction
  */
   ...
   * [E] dependent_privilege_descriptors_still_exist
  */
   ...
   * [E] fdw_inconsistent_descriptor_information
  */
  ...
  /** Class HV - Foreign Data Wrapper Error (SQL/MED):
   * [E] fdw_invalid_descriptor_field_identifier
  */
  ...
  /** Class HV - Foreign Data Wrapper Error (SQL/MED):
   * [E] fdw_invalid_string_length_or_buffer_length
  */
...
export default EnumPostgresErrorCode;
